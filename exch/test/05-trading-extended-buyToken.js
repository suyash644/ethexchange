...
contract('Exchange Order Tests', function (accounts) {
    before(function() {
        ...
        return exchange.deployed().then(function (instance) {
            ...
            return instanceExchange.depositToken("SUYASH", 2000, {from: accounts[1]});
        });
    });
    ...
    it("should be possible to add fully fulfill buy orders", function () {
        ...
        return exchange.deployed().then(function (instance) {
            ...
            return myExchangeInstance.sellToken("SUYASH", web3.toWei(2, "finney"), 5, {from: accounts[1]});
        }).then(function(txResult) {
            /**
             * Assert the logs
             */
            ...
            return myExchangeInstance.buyToken("SUYASH", web3.toWei(3, "finney"), 5);
        }).then(function(txResult) {
