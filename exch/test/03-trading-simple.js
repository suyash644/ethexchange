...
contract('Simple Order Tests', function (accounts) {
    before(function() {
        ...
        return exchange.deployed().then(function (instance) {
            ...
            return SuyashToken.deployed();
        }).then(function(myTokenInstance) {
            instanceToken = myTokenInstance;
            return instanceExchange.addToken("SUYASH", instanceToken.address);
        }).then(function(txResult) {
            return instanceToken.approve(instanceExchange.address, 2000);
        }).then(function(txResult) {
            return instanceExchange.depositToken("SUYASH", 2000);
        });
    });
    ...
    it("should be possible to add a limit buy order", function () {
        ...
        return exchange.deployed().then(function (instance) {
            ...
            return myExchangeInstance.getBuyOrderBook.call("SUYASH");
            ...
            return myExchangeInstance.buyToken("SUYASH", web3.toWei(1, "finney"), 5);
        }).then(function(txResult) {
            /**
             * Assert the logs
             */
    ...
    it("should be possible to add three limit buy orders", function () {
        ...
        return exchange.deployed().then(function (exchangeInstance) {
            ...
            return myExchangeInstance.buyToken("SUYASH", web3.toWei(2, "finney"), 5); //we add one offer on top of another one, doesn't increase the orderBook
        }).then(function(txResult) {
            assert.equal(txResult.logs[0].event, "LimitBuyOrderCreated", "The Log-Event should be LimitBuyOrderCreated");
            return myExchangeInstance.buyToken("SUYASH", web3.toWei(1.4, "finney"), 5); //we add a new offer in the middle
        }).then(function(txResult) {
            assert.equal(txResult.logs[0].event, "LimitBuyOrderCreated", "The Log-Event should be LimitBuyOrderCreated");
            return myExchangeInstance.getBuyOrderBook.call("SUYASH");
        }).then(function(orderBook) {
    ...
    it("should be possible to add two limit sell orders", function () {
        ...
        return exchange.deployed().then(function (instance) {
            myExchangeInstance = instance;
            return myExchangeInstance.getSellOrderBook.call("SUYASH");
        }).then(function (orderBook) {
            return myExchangeInstance.sellToken("SUYASH", web3.toWei(3, "finney"), 5);
        }).then(function(txResult) {
            /**
             * Assert the logs
             */
            ...
            return myExchangeInstance.sellToken("SUYASH", web3.toWei(6, "finney"), 5);
        }).then(function(txResult) {
            return myExchangeInstance.getSellOrderBook.call("SUYASH");
        }).then(function(orderBook) {
    ...
    it("should be possible to create and cancel a buy order", function () {
        ...
        return exchange.deployed().then(function (instance) {
            ...
            orderBookLengthBeforeBuy = orderBook[0].length;
            return myExchangeInstance.buyToken("SUYASH", web3.toWei(2.2, "finney"), 5);
        }).then(function(txResult) {
            ...
            return myExchangeInstance.cancelOrder("SUYASH", false, web3.toWei(2, "finney"), orderKey);
        }).then(function(txResult) {
